			...
			<nav class="navbar navbar-default sidebar azul_oscuro" role="navigation">
			    ...
			    <div class="collapse navbar-collapse azul_oscuro" id="bs-sidebar-navbar-collapse-1">
			      <ul class="nav navbar-nav">
			        <li @if(URL::current() . "/" == URL::to('prestamos')) class="active" @endif><a href="prestamos">Iniciar Prestamo<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>      
			        ...
			        <li><a href="book">Agregar Libros<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-book"></span></a></li>
			      </ul>
			    </div>
			  </div>
			</nav>
